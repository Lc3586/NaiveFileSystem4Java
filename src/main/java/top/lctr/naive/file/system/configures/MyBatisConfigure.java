...
//    public MyBatisConfigure(Environment env) {
//        this.env = env;
//    }
//
//    /**
...
//            }
//            if (allResult.size() > 0) {
//                typeAliasesPackage = String.join(",",
//                                                 allResult.toArray(new String[0]));
//            } else {
...
//        VFS.addImplClass(MybatisSpringBootVFS.class);
//
